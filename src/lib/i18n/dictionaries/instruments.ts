/**
 * Copy that belongs to instruments themselves rather than to one tool.
 * Categories group the tuner's picker and the play tool's picker alike,
 * so neither owns them.
 */
export const instruments = {
  zh: {
    "instrument.category.keys": "键盘乐器",
