/** The tuning & analysis tool: tuner, pitch, chord, key, spectrum, sources. */
export const tuning = {
  zh: {
    tunerTitle: "乐器调音",
    ...
    tunerDraw: "吸",
    tunerFingering: "指法",
    "tuner.windKey.octave": "泛音键",
    "tuner.windKey.overblow": "超吹",
    "tuner.kind.open": "空弦",
    "tuner.kind.blow": "吹",
    "tuner.kind.draw": "吸",
  ...
  en: {
    ...
    tunerBlow: "Blow",
    tunerDraw: "Draw",
    tunerFingering: "Fingering",
    "tuner.windKey.octave": "Octave key",
    "tuner.windKey.overblow": "Overblow",
    "tuner.kind.open": "Open string",
